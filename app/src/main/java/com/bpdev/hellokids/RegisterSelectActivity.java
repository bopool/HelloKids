    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RegisterSelectActivity.this,RegisterSelectActivity.class);
        ...
        btnBottomHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegisterSelectActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegisterSelectActivity.this, NoticeListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomDailyNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegisterSelectActivity.this, DailynoteListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomSchoolbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 선생님화면
                Intent intent = new Intent(RegisterSelectActivity.this, SchoolbusListActivity.class);
                startActivity(intent);
...
//                startActivity(intent);
        ...
        btnBottomSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RegisterSelectActivity.this, SettingListActivity.class);
                startActivity(intent);
            }
        });
