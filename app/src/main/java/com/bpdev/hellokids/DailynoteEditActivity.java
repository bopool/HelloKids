...
public class DailynoteEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dailynote_edit);
        ...
        id = dailyNoteRow.getId();

        textChildName.setText(childName);
        textDate.setText(date);
        editInputTitle.setText( dailyNoteRow.getTitle() );
        editInputContents.setText(dailyNoteRow.getContents());
        editInputTemp.setText( dailyNoteRow.getDailyTemperCheck() );
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 1. 레트로핏 변수 생성
                Retrofit retrofit = NetworkClient.getRetrofitClient(DailynoteEditActivity.this);
                ...
                Call<Result> call = api.dailyNoteEdit(id,"Bearer "+token,dailyNote);
                ...
                call.enqueue(new Callback<Result>() { // 받아왔을때 처리하는 코드
                    ...
                    public void onResponse(Call<Result> call, Response<Result> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            // 메인 액티비티를 실행하고,
                            // 이 액티비티는 종료해야 한다.
                            Intent intent = new Intent(DailynoteEditActivity.this, DailynoteListActivity.class);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailynoteEditActivity.this,RegisterSelectActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailynoteEditActivity.this,LoginActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailynoteEditActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailynoteEditActivity.this, NoticeListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomSchoolbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 선생님화면
                Intent intent = new Intent(DailynoteEditActivity.this, SchoolbusListActivity.class);
                startActivity(intent);
...
//                startActivity(intent);
        ...
        btnBottomSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DailynoteEditActivity.this, SettingListActivity.class);
                startActivity(intent);
            }
        });
