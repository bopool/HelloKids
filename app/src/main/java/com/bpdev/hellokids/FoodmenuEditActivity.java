...
public class FoodmenuEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, RegisterSelectActivity.class);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, LoginActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, NoticeListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomDailyNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, DailynoteListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomSchoolbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 선생님화면
                Intent intent = new Intent(FoodmenuEditActivity.this, SchoolbusListActivity.class);
                startActivity(intent);
        ...
        btnBottomSetting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodmenuEditActivity.this, SettingListActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void showDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(FoodmenuEditActivity.this);
    ...
    private void camera(){
        int permissionCheck = ContextCompat.checkSelfPermission(
                FoodmenuEditActivity.this, android.Manifest.permission.CAMERA);

        if(permissionCheck != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(FoodmenuEditActivity.this,
                    new String[]{android.Manifest.permission.CAMERA} ,
                    1000);
            Toast.makeText(FoodmenuEditActivity.this, "카메라 권한 필요합니다.",
                    Toast.LENGTH_SHORT).show();
            return;
        } else { // 권한 허가했다면
            Intent i = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            if(i.resolveActivity(FoodmenuEditActivity.this.getPackageManager())  != null  ){

                // 사진의 파일명을 만들기
                String fileName = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
                photoFile = getPhotoFile(fileName);

                Uri fileProvider = FileProvider.getUriForFile(FoodmenuEditActivity.this,
                ...
                Toast.makeText(FoodmenuEditActivity.this, "카메라 앱이 없습니다.",
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//            requestPermission();
    ...
    private boolean checkPermission(){
        int result = ContextCompat.checkSelfPermission(FoodmenuEditActivity.this,
    ...
    private void requestPermission() {
        if(ActivityCompat.shouldShowRequestPermissionRationale(FoodmenuEditActivity.this,
                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            Log.i("DEBUGGING5", "true");
            Toast.makeText(FoodmenuEditActivity.this, "권한 수락이 필요합니다.",
                    Toast.LENGTH_SHORT).show();
        }else{
        ...
        switch (requestCode) {
            case 1000: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(FoodmenuEditActivity.this, "권한 허가 되었음",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(FoodmenuEditActivity.this, "아직 승인하지 않았음",
                            Toast.LENGTH_SHORT).show();
