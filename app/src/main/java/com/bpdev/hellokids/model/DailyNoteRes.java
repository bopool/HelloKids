...
public class DailyNoteRes {
    ...
    public DailyNoteRes(int id, int teacherId, int childId, String title, String contents, String photoUrl, String dailyTemperCheck, String dailyMealCheck, String dailyNapCheck, String dailyPooCheck) {
        this.id = id;
