...
public class SettingSchoolbusAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                call.enqueue(new Callback<BusRes>() { // 받아왔을때 처리하는 코드
                    ...
                    public void onResponse(Call<BusRes> call, Response<BusRes> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Intent intent = new Intent(SettingSchoolbusAddActivity.this,SettingSchoolbusListActivity.class);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingSchoolbusAddActivity.this,RegisterSelectActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingSchoolbusAddActivity.this,LoginActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingSchoolbusAddActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomNotice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingSchoolbusAddActivity.this, NoticeListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnBottomDailyNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingSchoolbusAddActivity.this, DailynoteListActivity.class);
                startActivity(intent);
            }
        });
...
//                startActivity(intent);
        ...
        btnBottomSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SettingSchoolbusAddActivity.this, SettingListActivity.class);
                startActivity(intent);
            }
        });
